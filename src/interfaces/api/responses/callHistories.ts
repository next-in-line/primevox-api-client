export interface IPrimevoxApiCallHistoryResponseCall {
        ...
        callRecorded: number, // callRecorded - 1 if the call was recorded, 0 if the call was not recorded - Integer/Bool
        ...
        callFlagged: number, // callFlagged - Whether the call is flagged for follow-up - 1 or 0
...
export interface IPrimevoxApiCallHistoryResponse {
    [uuid: string]: IPrimevoxApiCallHistoryResponseCall
}